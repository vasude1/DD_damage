function [distance_,grad] = distance(mechanical,B,material,Mass_sigma,nelements,C,area,C_sig_lag,bfv)
    ...
    dist3 = mtimes(mechanical(nnodes+nelements+1:2*nnodes+nelements,1)', mtimes(C_sig_lag_ar, stress_mech' ) - bfv);
    ...
    if nargout > 1 % gradient required
        ...
        grad(nnodes+nelements+1:2*nnodes+nelements) = mtimes(C_sig_lag_ar, stress_mech')-bfv;
    end
end
